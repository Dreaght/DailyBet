...
public class UserTest extends TestCase {
    ...
    public void testUpdate() {
        final OfflinePlayerStub base1alt = createFakePlayer(server, base1.getName());
    ...
    public void testHome() {
        ...
        final OfflinePlayerStub base2 = createFakePlayer(server, base1.getName());
    ...
    public void testCommand() {
        Bukkit.dispatchCommand((Player) base1, "bet start 100");
        Bukkit.dispatchCommand((Player) base1, "bet 10");
    }
}